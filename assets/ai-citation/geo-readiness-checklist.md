# GEO maintenance checklist

- [ ] The first paragraph states the canonical project name, category, public URL, and current status.
...
- [ ] Local links, JSON/CFF metadata, the read-only citation renderer, public claims, and `make check` pass.
- [ ] Any GEO evaluation records its date, query set, model/platform, and answer summary using `geo-evaluation-report.template.json`; no ranking or citation guarantee is inferred.

Passing this checklist means that documentation is maintained within its evidence boundary. It does not prove mathematical correctness, search ranking, or AI citation.
