...
The method-layer source of truth is [`../../governance/standards/FORMAL-METHODS-MAP.md`](../../governance/standards/FORMAL-METHODS-MAP.md): Specification & Semantics through verification methods, with Lean positioned in dependent-type-theory deductive verification. The top-level lifecycle source of truth is [`../../governance/standards/RESEARCH-LIFECYCLE-MODEL-v0.1.md`](../../governance/standards/RESEARCH-LIFECYCLE-MODEL-v0.1.md). The bilingual answer matrix covers methodology, citation boundaries, lifecycle, and freshness/authority as Q10–Q13.
