...
- [`architecture.svg`](architecture.svg) is a static, accessible two-layer architecture overview for the README.
- [`ai-citation/`](ai-citation/) contains bilingual summaries, FAQ answers, terminology, category comparisons, Schema.org entity metadata, and a reproducible GEO evaluation protocol/report template.
