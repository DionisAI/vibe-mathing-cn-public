...
- [`ai-citation/`](ai-citation/) contains summaries, FAQ answers, terminology, category comparisons, Schema.org entity metadata, and a reproducible GEO evaluation protocol/report template.
