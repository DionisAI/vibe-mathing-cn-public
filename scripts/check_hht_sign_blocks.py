#!/usr/bin/env python3
"""Compile the locked ordered-compression statements and audit every dependency."""
...
SOURCE=WORK/'HHTSignBlocks.lean'
...
def main():
    ...
    names=['HHTSignBlocks.'+n for n in re.findall(r'^theorem\s+(\w+)',s,re.M)]
    if len(names)!=10 or len(set(names))!=10:raise ValueError('unexpected theorem manifest')
    ...
    print('SIGN_BLOCK_LEAN_PASS: 10 audited theorems; full finite determinant mixing and ordered compression; xi/Fekete/Sylvester external.')
    return 0
