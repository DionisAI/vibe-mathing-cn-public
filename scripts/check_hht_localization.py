#!/usr/bin/env python3
"""Compile HHT006 lemmas with the existing pinned Lean project.
...
SOURCE = WORK/'HHTLocalization.lean'
...
def main() -> int:
    ...
    print('HHT006_LEAN_PASS: 10 explicit lemmas; not the full spectral equivalence or RH.')
    return 0
