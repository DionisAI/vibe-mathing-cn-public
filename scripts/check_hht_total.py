...
def main():
    ...
    names=['HHTTotal.'+n for n in re.findall(r'^theorem\s+(\w+)',s,re.M)]
    if len(names)!=11 or len(set(names))!=11:raise ValueError('unexpected theorem manifest')
    ...
    print('TOTAL_LEAN_PASS: 11 audited theorems; all-gap TP2 and conditional dimension recurrence; TP10 Fekete and xi backend not formalized.')
    return 0
