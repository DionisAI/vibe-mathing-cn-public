...
├── RESEARCH-LIFECYCLE-MODEL-v0.1.md # Project → Workflow → Task → Step → Job 顶层模型
...
- `RESEARCH-LIFECYCLE-MODEL-v0.1.md` 是 Project → Workflow → Task → Step → Job 的顶层生命周期模型；它不宣称已有通用调度器或新增持久化层级。
